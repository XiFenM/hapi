...
export class ApiClient {
    ...
    // Fork: per-machine Claude model list (read/write)
    ...
    // Upstream: workspace-scoped directory listing
    ...
    async spawnSession(
        ...
        return await this.request<SpawnResponse>(`/api/machines/${encodeURIComponent(machineId)}/spawn`, {
            method: 'POST',
            body: JSON.stringify({ directory, agent, model, modelReasoningEffort, yolo, sessionType, worktreeName, effort, allowedTools })
        })
    }
