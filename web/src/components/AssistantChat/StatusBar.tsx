...
export function StatusBar(props: {
    ...
    const contextWarning = useMemo(
        () => {
            ...
            // Priority: explicit machine override > generic contextWindow prop > hardcoded fallback
            const maxContextSize = (props.contextWindowOverride && props.contextWindowOverride > 0)
                ? props.contextWindowOverride
                : (props.contextWindow ?? getContextBudgetTokens(props.model, props.agentFlavor))
            if (!maxContextSize) return null
            return getContextWarning(props.contextSize, maxContextSize, t)
        },
        [props.contextSize, props.contextWindow, props.contextWindowOverride, props.model, props.agentFlavor, t]
    )
