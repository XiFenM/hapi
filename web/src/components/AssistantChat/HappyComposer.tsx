...
export function HappyComposer(props: {
    ...
    const modelOptions = useMemo(
        () => getModelOptionsForFlavor(agentFlavor, model, availableModelOptions, claudeModels),
        [agentFlavor, model, availableModelOptions, claudeModels]
    )
    ...
    useEffect(() => {
        const handleGlobalKeyDown = (e: globalThis.KeyboardEvent) => {
            if (e.key === 'm' && (e.metaKey || e.ctrlKey) && onModelChange && supportsModelChange(agentFlavor)) {
                e.preventDefault()
                onModelChange(getNextModelForFlavor(agentFlavor, model, availableModelOptions, claudeModels))
                haptic('light')
            }
        }
    ...
    }, [model, onModelChange, haptic, agentFlavor, availableModelOptions, claudeModels])
